...
> 上一章：[01a_moe_all_to_all.md](/2026/07/24/ep-learning-01a-moe-all-to-all/) ← [01_ep_fundamentals.md](/2026/07/24/ep-learning-01-ep-fundamentals/)  
> 下一章：[02a_deepgemm.md](/2026/07/24/ep-learning-02a-deepgemm/)（DeepGEMM 细讲）→ [03_deepep.md](/2026/07/24/ep-learning-03-deepep/)
...
| DeepGEMM | `experts/deep_gemm_moe.py`, `batched_deep_gemm_moe.py` | DeepSeek 系高性能；细讲见 [02a_deepgemm.md](/2026/07/24/ep-learning-02a-deepgemm/) |
