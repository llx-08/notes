...
第 3 点就是 [01 章](/notes/2026/08/25/2026-08-25-mooncake-store-kv-scheduling-01-store-architecture/) 里那个「探测即续命」——
...
这里有一个已知的不利事实（见 [01 章](/notes/2026/08/25/2026-08-25-mooncake-store-kv-scheduling-01-store-architecture/)）：
