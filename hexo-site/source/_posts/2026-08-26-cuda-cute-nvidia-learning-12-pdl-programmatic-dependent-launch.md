---
title: "12. PDL（Programmatic Dependent Launch）：把 kernel 之间的缝隙压掉"
date: 2026-08-26
...
前面几章讲的都是**一个 kernel 内部**怎么快：tiling（[04](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-04-gemm-mma-tensor-core/)）、
架构指令演进（[05](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-05-ampere-hopper-blackwell/)）、软件流水线与延迟隐藏
（[11](/notes/2026/08/26/2026-08-26-cuda-cute-nvidia-learning-11-gemm-pipeline-deep-dive/)）。
...
> 不同进程（context）之间——见 [第 13 章](/notes/2026/08/26/2026-08-26-cuda-cute-nvidia-learning-13-context-stream-concurrency/)。三层是正交的，
> 机制完全不同。
...
[11](/notes/2026/08/26/2026-08-26-cuda-cute-nvidia-learning-11-gemm-pipeline-deep-dive/) §1）被流水线深度吃掉。
...
H20 和 GB200 的静态资源相同（实测，见 [07](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-07-blackwell-gb200-lab/)）：
...
[11](/notes/2026/08/26/2026-08-26-cuda-cute-nvidia-learning-11-gemm-pipeline-deep-dive/) 与 [07](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-07-blackwell-gb200-lab/) 的 SM 单元吞吐
