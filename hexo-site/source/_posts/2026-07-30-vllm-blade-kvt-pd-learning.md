---
title: "vLLM、Blade-KVT 与 PD 分离：从请求到 KV Cache 的完整生命周期"
date: 2026-07-30
...
2. Blade-KVT 调用的 Barex 源码，以及本仓库
   [NCCL、PCIe 与 Barex 学习笔记](/notes/2026/07/27/2026-07-27-nccl-pcie-barex-learning/)；
...
| 顺序 | 章节 | 读完应能回答 |
|---:|---|---|
| 0 | [00 架构与术语](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-00-architecture-and-terms/) | P、D、Scheduler、Worker、Hybrid Connector、Blade-KVT、Barex 各在哪一层？ |
| 1 | [01 请求生命周期](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-01-request-lifecycle/) | 请求为什么会被 Hybrid Connector “吃掉”，何时重新进入普通 Scheduler？ |
| 2 | [02 KV Block 生命周期](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-02-kv-block-lifecycle/) | Block 如何分配、缓存、引用、零化、延迟释放，为什么传输期间不会被复用？ |
| 3 | [03 PD 控制面](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-03-pd-control-plane/) | D 如何找到 P、P/D 如何 rendezvous，step/substep 和 TP rank 如何对应？ |
| 4 | [04 KV 发送路径](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-04-kv-send-path/) | 从 `PReqMeta` 到 `IpcBlock`、CUDA Event、`WriteBatch` 的完整调用链是什么？ |
| 5 | [05 KV 接收路径与完成语义](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-05-kv-receive-and-completion/) | TCP、RDMA Direct、staged RDMA 的落盘路径和 completion 边界有什么不同？ |
| 6 | [06 线程、CUDA Event 与流水线](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-06-threads-cuda-events-and-pipeline/) | 发送线程怎样分配，为什么它只阻塞自己，如何与 forward 按层重叠？ |
| 7 | [07 Python 协程与防 hang 设计](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-07-hybrid-asyncio-and-no-hang/) | 两个 uvloop、RPC、Future、队列唤醒如何协作，哪里有超时、哪里没有？ |
| 8 | [08 错误传播与 corner cases](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-08-errors-and-corner-cases/) | 断连、重复完成、abort、finish/save 竞态、404/410、TP 缺信号分别怎样处理？ |
| 9 | [09 调试、测试与代码地图](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-09-debugging-testing-code-map/) | 出现 hang、错 KV、内存泄漏或慢传输时从哪里开始查？ |
| 10 | [10 ATA 五篇串讲：PD 分离、GDR、传输优化与 asyncio](/notes/2026/08/26/2026-08-26-vllm-blade-kvt-pd-learning-10-ata-pd-gdr-asyncio-synthesis/) | KVT/Hybrid Connector 为什么这样演进，RDMA 小包怎样优化，协程语义如何影响控制面可靠性？ |
| 11 | [11 无中生有的 NaN：vLLM 全局 CUDA Stream 污染](/notes/2026/08/26/2026-08-26-vllm-blade-kvt-pd-learning-11-ata-nan-vllm-cuda-stream-thread-pollution/) | Connector 线程为何会改变主线程的 NCCL stream，并分别导致 NaN 与 invalid resource handle？ |
