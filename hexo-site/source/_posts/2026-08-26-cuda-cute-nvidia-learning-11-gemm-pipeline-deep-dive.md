---
title: "11. GEMM 软件流水线：从延迟隐藏到 roofline 里的那个 max"
date: 2026-08-26
...
前面几章已经分别讲过 tiling（[04](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-04-gemm-mma-tensor-core/)）、架构指令演进
（[05](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-05-ampere-hopper-blackwell/)）和 CuTe 的 pipeline 抽象
（[09](/notes/2026/07/29/2026-07-29-cuda-cute-nvidia-learning-09-cute-dsl-gemm-pipeline/)）。它们回答了「流水线长什么样」。
...
相关背景见 [05 KV 接收与完成语义](/notes/2026/07/30/2026-07-30-vllm-blade-kvt-pd-learning-05-kv-receive-and-completion/)
所在的 PD 分离系列。
