...
> 已有专题笔记：[vllm_cross_node_expert_parallelism.md](/2026/06/17/vllm-cross-node-expert-parallelism/)、[rdma_learning_1.md](/2026/05/25/rdma-learning-1/)
...
| 1 | [01_ep_fundamentals.md](/2026/07/24/ep-learning-01-ep-fundamentals/) | 什么是 MoE/EP？`EP=TP×DP` 怎么来的？ | 2–3h |
| 1a | [01a_moe_all_to_all.md](/2026/07/24/ep-learning-01a-moe-all-to-all/) | All-to-All 原因/载荷/流程；与 All-Gather、All-Reduce 对比 | 2–3h |
| 2 | [02_modular_kernel_and_moe_kernels.md](/2026/07/24/ep-learning-02-modular-kernel-and-moe-kernels/) | Router → Dispatch → Experts → Combine；align/permute/GEMM | 4–6h |
| 2a | [02a_deepgemm.md](/2026/07/24/ep-learning-02a-deepgemm/) | DeepGEMM：grouped contiguous、FP8、vLLM Experts 路径（含图） | 3–4h |
| 3 | [03_deepep.md](/2026/07/24/ep-learning-03-deepep/) | DeepEP HT/LL、RDMA buffer、与 NCCL/PPLX 对比 | 4–6h |
| 4 | [04_megamoe.md](/2026/07/24/ep-learning-04-megamoe/) | DeepSeek V4 MegaMoE、DeepGEMM、`prepare_megamoe` | 3–4h |
| 5 | [05_eplb_and_load_balance.md](/2026/07/24/ep-learning-05-eplb-and-load-balance/) | 热点 expert、分层 rebalance、物理/逻辑 expert | 2–3h |
| 6 | [06_code_reading_map.md](/2026/07/24/ep-learning-06-code-reading-map/) | 按文件/函数的精读顺序 | 随读 |
| 7 | [07_practice_checklist.md](/2026/07/24/ep-learning-07-practice-checklist/) | 动手实验、调试清单、常见坑 | 随练 |
...
> 「home / 原 rank」≠「唯一做 Attn 的 TP」：Attn 同 DP 内各 TP 都算同一批 token；详见 [01 §3.3](/2026/07/24/ep-learning-01-ep-fundamentals/#33-token-原-rank--home指什么易混点)。
...
| All-to-All | MoE 下 token↔expert rank 的多对多交换；细讲见 [01a](/2026/07/24/ep-learning-01a-moe-all-to-all/) |
| Logical / Physical Expert | 逻辑 expert（模型定义）vs 物理副本（EPLB 可复制热点） |
| DeepEP | DeepSeek 开源的 EP all-to-all 库（`deep_ep`），含 HT / LL 两套 kernel |
| DeepGEMM | DeepSeek FP8/FP4 GEMM 库；MoE 用 grouped contiguous；见 [02a](/2026/07/24/ep-learning-02a-deepgemm/) |
...
1. **CUDA / 通信基础**：stream、event、P2P、NCCL collective；跨机部分建议先过一遍 [rdma_learning_1.md](/2026/05/25/rdma-learning-1/)。
...
- [vllm_cross_node_expert_parallelism.md](/2026/06/17/vllm-cross-node-expert-parallelism/)：跨机 EP 拓扑、后端表、OOM 陷阱——本系列的「实战专题」，学完 01–03 后精读。
