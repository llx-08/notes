...
> 实现仍以 [06 Barex 架构](06_barex_architecture.md) 与源码为准。

## 1. 文章补上了什么视角

[06 Barex 架构](06_barex_architecture.md) 从固定版本源码解释对象、线程、WR、
...
详见 [08 blade-kvt 发送路径](08_blade_kvt_barex_send_path.md)。

## 11. 文章概念与当前笔记/源码的映射

| 文章中的设计 | 本仓库中的落点 |
|---|---|
| Read/Write/Send 抽象 | [06 第 7–9 节](06_barex_architecture.md) |
| DoneCallback 传递异步错误 | [06 第 11–12 节](06_barex_architecture.md) |
| `wr_id` 关联请求上下文 | `x_wr_id`、`ProcessOneIoEvent()` |
| QP error → flush → drain → delete | [09 CQ 异步错误](09_debugging_and_performance_playbook.md) |
...
| PD layer-by-layer overlap | [08 blade-kvt 发送路径](08_blade_kvt_barex_send_path.md) |
...
- [06 Barex 1.5.3-1 架构与发送实现](06_barex_architecture.md)
- [02c RoCE、拥塞控制、PFC/ECN 与重传](02c_roce_congestion_and_tuning.md)
- [08 blade-kvt 的 Barex 发送路径](08_blade_kvt_barex_send_path.md)
- [09 调试与性能分析手册](09_debugging_and_performance_playbook.md)
