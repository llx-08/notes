...
| 顺序 | 文档 | 核心问题 |
|---:|---|---|
| 0 | [00 硬件与网络零基础导读](00_hardware_network_primer.md) | bit/Byte、带宽/延迟、PCIe x16、DMA、网卡和 RDMA 分别是什么？ |
...
| 10 | [10 代码地图与术语](10_code_reading_map_and_glossary.md) | 应按什么顺序精读代码？常用术语如何对应？ |
...
[00 零基础导读](00_hardware_network_primer.md) 中的十个自检题，再进入 PCIe 与
...
已有的 [RDMA 学习笔记 1](../rdma_learning_1.md) 和
[RDMA 学习笔记 2](../rdma_learning_2.md) 保留为概念入口与数据中心网络专题；
