...
> 上一章：[05_eplb_and_load_balance.md](05_eplb_and_load_balance.md)  
> 实践：[07_practice_checklist.md](07_practice_checklist.md)
...
先读完 [01a_moe_all_to_all.md](01a_moe_all_to_all.md)，再进代码。
...
| 6 | `.../experts/deep_gemm_moe.py` 或 `triton_moe.py` | align 输出如何喂给 GEMM；DeepGEMM 细读见 [02a](02a_deepgemm.md) |
