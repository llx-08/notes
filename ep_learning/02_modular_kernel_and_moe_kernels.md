...
> 上一章：[01a_moe_all_to_all.md](01a_moe_all_to_all.md) ← [01_ep_fundamentals.md](01_ep_fundamentals.md)  
> 下一章：[02a_deepgemm.md](02a_deepgemm.md)（DeepGEMM 细讲）→ [03_deepep.md](03_deepep.md)
...
| DeepGEMM | `experts/deep_gemm_moe.py`, `batched_deep_gemm_moe.py` | DeepSeek 系高性能；细讲见 [02a_deepgemm.md](02a_deepgemm.md) |
