...
[第 12 章](12_pdl_programmatic_dependent_launch.md) 讲的是**同一条 stream 上相邻两个
...
- 本系列 [第 12 章：PDL](12_pdl_programmatic_dependent_launch.md)、
  [第 1 章：CUDA 执行模型](01_cuda_execution_model.md)、
  [第 2 章：SM / CUDA Core / Tensor Core](02_sm_cuda_core_tensor_core.md)
