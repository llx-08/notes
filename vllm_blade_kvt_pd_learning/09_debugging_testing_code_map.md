...
[RDMA 操作与完成](../nccl_pcie_barex_learning/02b_rdma_operations_completion_and_reliability.md)
与 [RoCE 拥塞](../nccl_pcie_barex_learning/02c_roce_congestion_and_tuning.md)。
